...
public class WaitRecordFragment extends Fragment {
     ...
     * @return A new instance of fragment WaitRecordFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static WaitRecordFragment newInstance(String param1, String param2) {
        WaitRecordFragment fragment = new WaitRecordFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mView == null){
            mView = inflater.inflate(R.layout.fragment_wait_record, container, false);
            initWidget();
        }
        return mView;
    }
