...
public class WaitTaskFragment extends Fragment{
     ...
     * @return A new instance of fragment WaitTaskFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static WaitTaskFragment newInstance(String param1, String param2) {
        WaitTaskFragment fragment = new WaitTaskFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mView == null){
            mView = inflater.inflate(R.layout.fragment_wait_task, container, false);
            initWidget();
        }
        return mView;
    }
