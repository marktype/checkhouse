...
public class DevelopInfoActivity extends BascActivity implements AdapterView.OnItemClickListener{
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        Intent intent = new Intent(this, FinishDetialActivity.class);
